...
#
# Description: This is the script run by player 1. 
...
class GameSpace:
	def main(self):
		...
		self.start = False #True when Player 2 is connected
		self.GameOver = False
	...
	def loop(self):
		...
		#If it is player 1 turn, then send game state to player 2
